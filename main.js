let module_13= document.getElementById('open-modal3');
let back_btn= document.querySelector('.back_btn');
let new_page_title= document.querySelector('.new_page_title');
let new_page_plusBtn= document.querySelector('.new_page_plusBtn');
...
back_btn.addEventListener('click',(argu)=>{
  ...
  let temp=document.getElementsByClassName('index_box');
  for(let i of temp){
...
let con_box = document.getElementById("continer_box");
let object_arry = [];
let count = 0;
let plus_icon01 = [];
let trash_icon01 = [];

let modal2 = document.querySelector(".hidden2");
let inp_iteam = document.querySelector(".input_iteam");
let iteam_btn = document.querySelector(".add_button2");
let temp_id;
...
function plus_icon2(id) {
  ...
  iteam_btn.addEventListener('click', function () {
    if (inp_iteam.value == "") {
      ...
      let temp_task = document.getElementsByClassName('task_box');
...
function trash_icon2(id) {
  let temp_box = document.getElementsByClassName('index_box');
...
document.querySelector(".add_button").addEventListener("click", () => {
  if (inp_title.value == "") {
    ...
    let box_obj = inp_title.value; 
    let temp_title = box_obj;
